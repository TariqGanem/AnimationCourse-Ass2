...
namespace glfw
{
  ...
  public:
   ...
   // enum class MouseMode { None, Rotation, Zoom, Pan, Translation} mouse_mode;
    void drawAllignedBox(Eigen::AlignedBox<double, 3> box1, Eigen::AlignedBox<double, 3> box2, Eigen::RowVector3d color);
    bool interactionCheckRecursive(igl::AABB<Eigen::MatrixXd, 3> t1, igl::AABB<Eigen::MatrixXd, 3> t2, Eigen::Matrix4f A, Eigen::Matrix4f B);
    IGL_INLINE void animate();
    bool interactionCheck(Eigen::AlignedBox<double, 3> Box1, Eigen::AlignedBox<double, 3> Box2, Eigen::Matrix4f A, Eigen::Matrix4f B);
   ...
   // IGL_INLINE void draw();
    ...
    Eigen::MatrixXd setCorners(Eigen::AlignedBox<double, 3> box);
